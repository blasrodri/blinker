...
pub fn spike_hot_root(reading: SpikeReading, bias: u64) -> u64 {
    reading.total().wrapping_mul(7).wrapping_add(1).wrapping_add(bias)
}
...
pub extern "C" fn spike_entry(value: u64) -> u64 {
    ...
    spike_hot_root(reading, 9).wrapping_add(spike_helper(value)).wrapping_add(spike_convert(value))
}
